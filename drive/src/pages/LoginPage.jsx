  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-3xl shadow-xl border border-slate-100 relative z-10 animate-fade-in-up">
        ...
        <form className="mt-8 space-y-6" onSubmit={(e) => { e.preventDefault(); navigate('/drive'); }}>
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-3.5 px-4 border border-transparent text-sm font-semibold rounded-xl text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-md shadow-blue-600/20 transition-all active:scale-[0.98]"
            >
              Sign in
              <ArrowRight size={18} className="ml-2 text-blue-100 group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
          ...
          <div>
            <button
              ...
              className="w-full flex items-center justify-center py-3.5 px-4 border border-slate-200 text-sm font-semibold rounded-xl text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all active:scale-[0.98] shadow-sm"
            >
